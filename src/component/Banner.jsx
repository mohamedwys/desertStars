  ...
  return (
    <section className="max-w-screen-2xl p-4 md:px-14 mx-auto mt-20">
        <div className=" gradient-bg overflow-hidden px-8 py-8 md:p-12 rounded-xl rounded-br-[80px]">
            ...
            className="text-3xl lg:text-5xl bg-gradient-to-r from-[#ffde59] to-[#ff914d] bg-clip-text text-transparent font-black leading-[3rem] lg:leading-[5rem]">Desert Stars Children Choir DXB</motion.h1>
